        ...
        return this.each(function () {
            ...
            $(this).bind(settings.event, function (e) {
                if (
                    ...
                    true === $(this).data('disabled.editable') ||
                    /* prevent throwing an exeption if edit field is clicked again */
                    self.editing ||
                    /* abort if onedit hook returns false */
                    false === onedit.apply(this, [settings, self])
                ) {
                    return;
                }
                ...
                /* figure out how wide and tall we are, saved width and height are workaround for http://dev.jquery.com/ticket/2190 */
                if (0 == $(self).width()) {
                ...
                form.submit(function (e) {
                    ...
                    if (false !== onsubmit.apply(form, [settings, self])) {
                        /* custom inputs call before submit hook, if it returns false abort submitting */
